...
function Phi_phi_i_Gradq = constr2grad_rq(Rob, q, Tr0Ex, reci)
...
R_0_E_x = Tr0Ex(1:3,1:3); % [SchapplerTapOrt2019]/(6)
if reci
...
R_Ex_Eq = R_0_E_x' * R_0_E_q; % Argument aus [SchapplerTapOrt2019]/(9)
R_N_E = Rob.T_N_E(1:3,1:3); % Siehe Text vor [SchapplerTapOrt2019]/(32)

% Ableitung der Rotationsmatrix R_0_E nach q
% Term III aus Gl. (C.49) bzw. aus [SchapplerTapOrt2019]/(31)
% Gl. D.7
...
% Term II aus Gl. (C.49) bzw. II aus [SchapplerTapOrt2019]/(31)
...
% Term I aus Gl. (C.49) bzw. I aus [SchapplerTapOrt2019]/(31)
