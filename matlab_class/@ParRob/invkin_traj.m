...
%         h3dqa = h3drz * J_ax(end,:);
      ...
      if wn(15) ~= 0 || wn(16) ~= 0 % Quadr. Abstand von Phi bzgl. redundantem FHG von xlim maximieren
        ...
        v_qaD  = v_qaD  - wn(15)*h9dqa(:);
        v_qaDD = v_qaDD - wn(16)*h9dqa(:);
      end
      if wn(17) ~= 0 || wn(18) ~= 0 % Hyperb. Abstand außerhalb von xlim minimieren
        ...
        v_qaD  = v_qaD  - wn(17)*h10dqa(:);
        v_qaDD = v_qaDD - wn(18)*h10dqa(:);
      end
      if wn(19) ~= 0 % Quadr. Abstand von phiD bzgl. redundantem FHG von xDlim minimieren
        ...
        h11_test = invkin_optimcrit_limits1(XD6_k_diff+1e-6, s.xDlim(6,1:2));
    ...
    if (condJ >= thresh_ns_qa || sum(Rob.I_qa) ~= sum(Rob.I_EE) || debug) && ...
      ...
      if wn(15) ~= 0 || wn(16) ~= 0 % Quadr. Abstand von Phi bzgl. redundantem FHG von xlim maximieren
        ...
        v_qD  = v_qD  - wn(15)*h9dq(:);
        v_qDD = v_qDD - wn(16)*h9dq(:);
      end
      if wn(17) ~= 0 || wn(18) ~= 0 % Hyperb. Abstand außerhalb von xlim minimieren
        h(10) = invkin_optimcrit_limits2(Phi_r(1), s.xlim(6,1:2), xlim_thr_h10(6,:));
        h10_test = invkin_optimcrit_limits2(Phi_r(1)+1e-6, s.xlim(6,1:2), xlim_thr_h10(6,:));
...
%         XD_k = J_x_inv_test / qD_k;
        ...
        h11dq = (h11_test-h(11))./qD_test'; % Siehe [SchapplerOrt2021], Gl. 28
