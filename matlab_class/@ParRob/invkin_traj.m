...
if any(wn(11:12))
  ...
  % Vergrößere den Wert darüber hinaus. Der Wert unendlich kann erreicht werden.
  % Dann funktioniert die Gradientenbildung nicht mehr. Das ist dann aber
  % auch egal, da die Lösung nicht mehr zulässig ist.
