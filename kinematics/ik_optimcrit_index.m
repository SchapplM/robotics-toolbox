...
if Type < 2 % SerRob
  ...
  idx_ikpos_wn = struct( ...
    ...
    'coll_par', 9);
  % Gleiche Reihenfolge in Ausgabe-Variable h
  idx_ik_length.hnpos = 9;
  idx_ikpos_hn = idx_ikpos_wn;
  % Trajektorien-Indizes, aufgeteilt in P- und D-Anteil
  idx_ik_length.wntraj = 21;
  idx_iktraj_wnP = struct( ...
    'qlim_par', 1, ...
    'qlim_hyp', 2, ...
    'qDlim_par', 3, ...
