...
%% Kompilierung der Matlab-Funktionen
matlabfcn2mex({...
  'rigidbody_coriolisvecB_floatb_eulxyz_slag_vp1', ...
  'rigidbody_coriolisvecB_floatb_eulxyz_slag_vp2', ...
  'rigidbody_energykin_floatb_eulxyz_slag_vp1', ...
  'rigidbody_energykin_floatb_eulxyz_slag_vp2', ...
  'rigidbody_energypot_floatb_eulxyz_slag_vp1', ...
  'rigidbody_energypot_floatb_eulxyz_slag_vp2', ...
  'rigidbody_gravloadB_floatb_eulxyz_slag_vp1', ...
  'rigidbody_gravloadB_floatb_eulxyz_slag_vp2', ...
  'rigidbody_inertiaB_floatb_eulxyz_slag_vp1', ...
